...
const socialLinks = [
  ...
  {
    label: 'Instagram',
    href: 'https://instagram.com/guilhermeft',
    icon: (
      <svg
        className="h-5 w-5 fill-current"
        xmlns="http://www.w3.org/2000/svg"
...
export function Footer() {
  ...
  return (
    <motion.footer
      ...
      transition={shouldReduceMotion ? undefined : { duration: 0.6, ease: [0.3, 0, 0.5, 1] }}
    ...
    >
      <div className="container py-16">
        ...
        <div className="flex flex-col items-center gap-12 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col items-center gap-4 md:items-start">
            ...
            <p
              ...
              style={{ color: 'var(--color-gray-mid)', maxWidth: '28ch' }}
            >
              Software sob medida para negócios que querem crescer.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center gap-8 md:items-end">
              ...
              <ul className="flex flex-wrap justify-center gap-x-6 gap-y-3 md:justify-end">
                {navLinks.map(({ href, label }) => (
                  <li key={href}>
                    <a
                      href={href}
                      className="footer-link relative text-sm transition-colors duration-150"
            ...
            {/* Social icons */}
            <div className="flex items-center gap-5" role="list" aria-label="Redes sociais">
              {socialLinks.map(({ label, href, icon }) => (
                <motion.a
                  ...
                  whileHover={
                    shouldReduceMotion
                      ? {}
                      : { scale: 1.15, color: 'var(--color-accent)' }
                  }
        ...
        {/* Copyright */}
        <p
          className="text-center text-xs tracking-wide md:text-left"
          style={{ color: 'var(--color-gray-mid)' }}
        >
          © 2025 Guilherme FT — guilhermeft.dev
        </p>
      </div>
    </motion.footer>
  )
