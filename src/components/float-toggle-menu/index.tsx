...
export const FloatToggleMenu = () => {
  ...
  return (
    <motion.button
      ...
      className={cn(
        'bg-primary fixed top-4 right-2 z-50 flex h-16 w-16 cursor-pointer items-center justify-center rounded-full px-5 opacity-0 transition-all duration-500 hover:scale-105 md:h-20 md:w-20 md:px-7',
      )}
      initial={{
        opacity: 0,
        scale: 0,
