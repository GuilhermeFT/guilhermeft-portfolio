...
export function EmailModal({ emailAddress }: EmailModalProps) {
  ...
  return (
    <Dialog>
      <DialogTrigger className="bg-accent hover:bg-primary flex w-full items-center justify-center gap-2 rounded-lg py-3 font-medium text-white transition-colors">
